...
const CaptainLogin = () => {
  ...
  const handleFormSubmit = async(e) => {
    ...
    const res = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/captains/login`, captain);
    if(res.status===200){
  ...
  return (
    <div className="p-7 h-screen flex flex-col justify-between">
      ...
      />
      <div>
        <form className="p-7 pb-0" onSubmit={handleFormSubmit}>
          ...
          <input
            ...
            className="bg-[#eeeeee] mb-7 rounded-lg border px-4 py-2 w-full text-lg placeholder:text-base"
            required
            type="email"
